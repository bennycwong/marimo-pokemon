...
@app.cell
def _(Check, Column, DataFrameSchema):
...
@app.cell
def _(df_raw, pa, pokemon_schema):
...
@app.cell
def _(df_clean, pa, pokemon_schema):
...
@app.cell
def _(DATASET_PATH, pd, pl, time, validated_df):
    # Pandas benchmark
    def pandas_pipeline():
